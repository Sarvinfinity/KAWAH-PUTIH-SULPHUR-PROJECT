...
def main():
    SCRIPTS_DIR = os.path.dirname(os.path.abspath(__file__))
    PROJECT_ROOT = os.path.dirname(SCRIPTS_DIR)
    in_file = os.path.join(PROJECT_ROOT, 'datasets', 'all_data_ts.csv')
    print(f"Loading real 7H training data from '{in_file}'...")
    ...
    out_file = os.path.join(PROJECT_ROOT, 'datasets', 'expanded_24H_all_data.csv')
