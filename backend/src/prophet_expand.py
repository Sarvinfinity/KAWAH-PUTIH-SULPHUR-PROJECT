...
def generate_visualizations(df_original, df_pred):
    ...
    for feature, feature_name in feature_titles.items():
        ...
        filename = os.path.join(WORKSPACE_ROOT, "outputs", "plots", f"prophet_{feature.lower()}_comparison.png")
...
def main():
    ...
    out_file = os.path.join(WORKSPACE_ROOT, 'data', 'processed', 'prophet_expanded_24H.csv')
