...
DATA_PATH = os.path.join(WORKSPACE_ROOT, 'data', 'processed', 'expanded_24H_all_data.csv')
OUT_DIR = os.path.join(WORKSPACE_ROOT, 'outputs')
TABLES_DIR = os.path.join(OUT_DIR, 'reports')
FIGURES_DIR = os.path.join(OUT_DIR, 'plots')
